...
prep_links = as.data.frame(bind_rows(portal_sex, sex_age, age_bmi, race_bmi, race_organ, organ_ftu, ftu_ctann, ctann_rui, rui_atlas))
prep_links 
...
p <- sankeyNetwork(Links = prep_links, Nodes = nodes, Source = "source",
                   ...
                   units = "occurrences", fontSize = 10, nodeWidth = 20, width=1000, height = 650)
